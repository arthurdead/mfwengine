namespace mfw::stl
{
	...
	namespace __public_impl_default_delete_ipp MFW_VISIBILITY_LOCAL
	{
	...
	{
		__public_impl_default_delete_ipp::_default_delete_impl(__ptr, false);
	}
	...
	{
		_Tp *__tmp{__ptr};
		__public_impl_default_delete_ipp::_default_delete_impl(__tmp, false);
	}

	template <typename _Tp>
	void default_delete<_Tp[]>::operator()(_Tp *&__ptr) const noexcept
	{
		__public_impl_default_delete_ipp::_default_delete_impl(__ptr, true);
	}
	...
	{
		_Tp *__tmp{__ptr};
		__public_impl_default_delete_ipp::_default_delete_impl(__tmp, true);
	}
