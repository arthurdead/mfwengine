...
#define MFW_PROCESSOR_WASM (MFW_PROCESSOR_32BITS_FLAG|_MFW_BIT(_MFW_PROCESSOR_FLAGS_LAST_BIT+5))
...
#elif defined _MFW_WEB_DETECTED
	#define MFW_PROCESSOR MFW_PROCESSOR_WASM
#else
	#error
#endif