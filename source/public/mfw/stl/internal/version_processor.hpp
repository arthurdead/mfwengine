...
#define MFW_PROCESSOR_WASM_FLAG _MFW_BIT(4)
#define _MFW_PROCESSOR_FLAGS_LAST_BIT 4
...
#define MFW_PROCESSOR_WASM32 (MFW_PROCESSOR_WASM_FLAG|MFW_PROCESSOR_32BITS_FLAG|_MFW_BIT(_MFW_PROCESSOR_FLAGS_LAST_BIT+5))
#define MFW_PROCESSOR_WASM64 (MFW_PROCESSOR_WASM_FLAG|MFW_PROCESSOR_64BITS_FLAG|_MFW_BIT(_MFW_PROCESSOR_FLAGS_LAST_BIT+6))
#define MFW_PROCESSOR_ASMJS (MFW_PROCESSOR_32BITS_FLAG|_MFW_BIT(_MFW_PROCESSOR_FLAGS_LAST_BIT+7))
...
#define MFW_PROCESSOR_IS(what) (MFW_PROCESSOR == MFW_PROCESSOR_##what)
	...
	#define MFW_PROCESSOR MFW_PROCESSOR_ASMJS
#elif defined __wasm64__ || \
		defined __wasm64
	#define MFW_PROCESSOR MFW_PROCESSOR_WASM64
#elif defined __wasm32 || \
		defined __wasm32__ || \
		defined __wasm__ || \
		defined __wasm
	#define MFW_PROCESSOR MFW_PROCESSOR_WASM32
#else
	#error
#endif