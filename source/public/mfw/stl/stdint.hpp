#ifndef __MFW_PUBLIC_STL_STDINT_H
#define __MFW_PUBLIC_STL_STDINT_H
...
#if MFW_COMPILER_FLAGGED(UNIX) || defined __STDC_WANT_IEC_60559_TYPES_EXT__
...
#include <public/mfw/stl/detail/stdint_funcs.hpp>
