...
#define MFW_wSTRINGFY(x) __MFW_wSTRINGFY_IMPL(x)
	...
	#define MFW_ATTRIBUTE(...) __attribute__((__VA_ARGS__))
		...
		#define MFW_SHARED_EXPORT MFW_ATTRIBUTE(__visibility__("default"))
		#define MFW_SHARED_IMPORT MFW_ATTRIBUTE(__visibility__("default"))
...
#if defined __MFW_ENABLE_DEBUGBREAK || MFW_CONFIGURATION_IS(DEBUG)
	#if MFW_COMPILER_IS(MSVC)
