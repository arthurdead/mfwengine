#ifndef __MFW_PRIVATE_CORE_FILESYSTEM_H
#define __MFW_PRIVATE_CORE_FILESYSTEM_H
...
namespace mfw::core
{
	...
	public:
		...
		bool create_symlink(const searchpath &from, const searchpath &to) const override;
